...

{
  ...
  const convenience = new DropdownClass({ parentSelector: 'convenience', items: { спальни: 2, кровати: 2, 'ванные комнаты': 0 }, getListClass: (items) => new ListConvenience(items) });
